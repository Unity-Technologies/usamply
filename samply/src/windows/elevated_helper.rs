...
use crate::shared::recording_props::{CoreClrProfileProps, ProfileCreationProps, RecordingMode, RecordingProps};
...
impl ElevatedHelperSession {
    ...
    pub fn start_xperf(
        ...
        let xperf_args =
            ElevatedRecordingProps::from_recording_props(recording_props, profile_creation_props, recording_mode);
        match self
            .elevated_session
